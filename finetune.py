...
def train(
    # model/data params
    base_model: str = "../../v2/7B",  # the only required argument
    data_path: str = "./data_json/Z.json",
    output_dir: str = "./model_output/style_finetune/7B-styleme-8-qv",
    ...
    if data_path.endswith(".json") or data_path.endswith(".jsonl"):  data = load_dataset("json", data_files=data_path)
